...
print(maximum_square(test_array))

print(maximum_square(test_array2))

print(maximum_square(test_array3))

print(maximum_square(test_array4))
print(maximum_square(test_array5))
print(maximum_square(test_array6))
print(maximum_square(test_array7))
print(maximum_square(test_array8))
